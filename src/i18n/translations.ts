...
export const translations: Record<Lang, Record<string, any>> = {
  EN: {
    ...
    personalize: {
      ...
      pdfAddon: 'Add the premium PDF deep-dive analysis', pdfAddonSave: '25 % off', pdfNote: 'A 10–15 page personal analysis of your chart, delivered as a download.', pdfBadge: 'Digital PDF',
  ...
  DE: {
    ...
    personalize: {
      ...
      pdfAddon: 'Premium-PDF-Tiefenanalyse hinzufügen', pdfAddonSave: '25 % Rabatt', pdfNote: 'Eine 10–15-seitige persönliche Auswertung deines Charts als Download.', pdfBadge: 'Digitale PDF',
  ...
  FR: {
    ...
    personalize: {
      ...
      pdfAddon: 'Ajouter l’analyse PDF premium', pdfAddonSave: '−25 %', pdfNote: 'Une analyse personnelle de 10–15 pages de votre thème, livrée en téléchargement.', pdfBadge: 'PDF digital',
