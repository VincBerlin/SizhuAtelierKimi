...
export const translations: Record<Lang, Record<string, any>> = {
  EN: {
    ...
    personalize: {
      ...
      summaryHeading: '5 · Review your personalization', sumType: 'Product', partnerName: 'Partner', partnerData: 'Partner details', review: { heading: 'Your calculated chart', dayMaster: 'Day master', pillars: 'Four pillars', animal: 'Animal' }, timeUnknown: 'Unknown — 12:00 PM default', sumLang: 'Language', sumDesign: 'Design', sumSize: 'Size', sumPrice: 'Price',
  ...
  DE: {
    ...
    personalize: {
      ...
      summaryHeading: '5 · Personalisierung prüfen', sumType: 'Produkt', partnerName: 'Partner', partnerData: 'Partner-Daten', review: { heading: 'Dein berechnetes Chart', dayMaster: 'Tagesmeister', pillars: 'Vier Säulen', animal: 'Tierzeichen' }, timeUnknown: 'Unbekannt — Standard 12:00 Uhr', sumLang: 'Sprache', sumDesign: 'Design', sumSize: 'Format', sumPrice: 'Preis',
  ...
  FR: {
    ...
    personalize: {
      ...
      summaryHeading: '5 · Vérifiez votre personnalisation', sumType: 'Produit', partnerName: 'Partenaire', partnerData: 'Données du partenaire', review: { heading: 'Votre carte calculée', dayMaster: 'Maître du jour', pillars: 'Quatre piliers', animal: 'Animal' }, timeUnknown: 'Inconnue — 12:00 PM par défaut', sumLang: 'Langue', sumDesign: 'Design', sumSize: 'Format', sumPrice: 'Prix',
  ...
  ES: {
    ...
    personalize: {
      ...
      review: { heading: 'Tu carta calculada', dayMaster: 'Maestro del día', pillars: 'Cuatro pilares', animal: 'Animal' },
