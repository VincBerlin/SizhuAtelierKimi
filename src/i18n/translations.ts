...
export const translations: Record<Lang, Record<string, any>> = {
  ...
  FR: {
    ...
    personalize: {
      ...
      summaryHeading: '5 · Vérifiez votre personnalisation', sumType: 'Produit', partnerName: 'Partenaire', partnerData: 'Données du partenaire', review: { heading: 'Votre carte calculée', dayMaster: 'Maître du jour', pillars: 'Quatre piliers', animal: 'Animal', compat: { heading: 'Votre résultat expliqué', dayMasters: 'Maîtres du jour', rel: { a_generates_b: 'Dans le cycle des cinq éléments, {a} nourrit {b} : l’énergie du premier maître du jour renforce symboliquement celle du second — une dynamique généreuse et porteuse.', b_generates_a: 'Dans le cycle des cinq éléments, {b} nourrit {a} : l’énergie du second maître du jour renforce symboliquement celle du premier — une dynamique généreuse et porteuse.', a_controls_b: 'Dans le cycle des cinq éléments, {a} façonne {b} : une tension structurante — dans la pensée Wuxing, elle évoque des impulsions formatrices et une croissance par la différence.', b_controls_a: 'Dans le cycle des cinq éléments, {b} façonne {a} : une tension structurante — dans la pensée Wuxing, elle évoque des impulsions formatrices et une croissance par la différence.', same_element: 'Les deux maîtres du jour partagent l’élément {a} : une résonance de ressemblance — énergie familière et expression commune.', same: 'Les deux maîtres du jour partagent l’élément {a} : une résonance de ressemblance — énergie familière et expression commune.' }, note: 'Une lecture symbolique de la tradition des cinq éléments — une invitation à la réflexion, non un jugement de votre relation.' } }, timeUnknown: 'Inconnue — 12:00 PM par défaut', sumLang: 'Langue', sumDesign: 'Design', sumSize: 'Format', sumPrice: 'Prix',
  ...
  ES: {
    ...
    newsletter: {
      ...
      copy: 'Entérate primero de los nuevos pósters, ofertas de temporada, historias del atelier e inspiración para tus paredes — directo a tu bandeja de entrada. Como pequeño extra, a veces incluimos una nota energética Cosmic Pulse. ✨ Sin spam, cancela cuando quieras.',
      benefits: [
        'Nuevos pósters y colecciones',
        'Ofertas de temporada e ideas de regalo',
        'Historias del atelier · nota Cosmic Pulse ocasional'
      ],
    ...
    footer: {
      ...
      blog: 'Blog',
      groups: { service: 'Ayuda y servicio', discover: 'Descubrir', legal: 'Legal', contact: 'Contáctanos' },
      locale: 'Idioma',
      payment: 'Aceptamos',
