...
export const translations: Record<Lang, Record<string, any>> = {
  EN: {
    ...
    footer: { about: 'About', contact: 'Contact', faq: 'FAQ', shipping: 'Shipping', returns: 'Returns & Withdrawal', terms: 'Terms', privacy: 'Privacy', impressum: 'Imprint', claim: 'Personalized from your birth data · climate-neutral shipping' },
  ...
  DE: {
    ...
    footer: { about: 'Atelier', contact: 'Kontakt', faq: 'FAQ', shipping: 'Versand', returns: 'Rückgabe & Widerruf', terms: 'AGB', privacy: 'Datenschutz', impressum: 'Impressum', claim: 'Personalisiert aus deinen Geburtsdaten · klimaneutraler Versand' },
  ...
  FR: {
    ...
    footer: { about: 'Atelier', contact: 'Contact', faq: 'FAQ', shipping: 'Livraison', returns: 'Retours & rétractation', terms: 'CGV', privacy: 'Confidentialité', impressum: 'Mentions légales', claim: 'Personnalisé à partir de vos données de naissance · livraison neutre en carbone' },
