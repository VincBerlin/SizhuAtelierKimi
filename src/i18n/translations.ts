...
export const translations: Record<Lang, Record<string, any>> = {
  EN: {
    ...
    auth: {
      ...
      err: { invalid_email: 'Please enter a valid email address.', weak_password: 'Password must be at least 8 characters.', email_taken: 'An account with this email already exists.', invalid_credentials: 'Wrong email or password.', auth_unconfigured: 'Accounts are not available yet.', invalid_token: 'This reset link is invalid or has expired.', unauthorized: 'Please log in again.', wrong_password: 'Your current password is incorrect.', payment_unconfigured: 'Payment is not configured yet.', server_error: 'Something went wrong — please try again.', network_error: 'Network error — please try again.' },
    },
    account: {
  ...
  FR: {
    ...
    auth: {
      ...
      err: { invalid_email: 'Veuillez saisir une adresse e-mail valide.', weak_password: 'Le mot de passe doit comporter au moins 8 caractères.', email_taken: 'Un compte avec cet e-mail existe déjà.', invalid_credentials: 'E-mail ou mot de passe incorrect.', auth_unconfigured: 'Les comptes ne sont pas encore disponibles.', invalid_token: 'Ce lien de réinitialisation est invalide ou expiré.', unauthorized: 'Veuillez vous reconnecter.', wrong_password: 'Votre mot de passe actuel est incorrect.', payment_unconfigured: 'Le paiement n’est pas encore configuré.', server_error: 'Une erreur est survenue — veuillez réessayer.', network_error: 'Erreur réseau — veuillez réessayer.' },
    },
    account: {
