...
export const translations: Record<Lang, Record<string, any>> = {
  EN: {
    ...
    newsletter: { eyebrow: 'The Atelier Circle', title: 'The Cosmic Pulse — Your Weekly Energy Charts', copy: 'Align your days with celestial precision. Subscribe to receive our weekly Energy Charts straight to your inbox — a profound astrological analysis tracking the current cosmic shifts and giving you an exact energetic roadmap for the upcoming week. You’ll also be first to receive our marketing updates — new product launches, collections and exclusive offers. ✨ No spam, just relevant insights.', benefits: ['Weekly Energy Charts to your inbox', 'New product & collection launches', 'Fire Horse 2026 & TCM releases', 'Early access & exclusive drops', 'Seasonal gift-idea campaigns'], placeholder: 'Your email address', langPref: 'Emails in', button: 'Subscribe', consent: 'I agree to receive weekly energy charts, product insights, product launch announcements and marketing emails from SizhuAtelier. I can unsubscribe at any time. See our', privacy: 'Privacy Policy', success: 'Welcome to the Atelier Circle — check your inbox to confirm your subscription.', error: 'Something went wrong — please try again.', consentErr: 'Please accept the terms to continue.', fine: 'Double opt-in · unsubscribe anytime' },
